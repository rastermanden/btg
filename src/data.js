export const BTG_DATA = {
  ...
  players: [
    ...
    { no: 4, first: 'Troels', last: 'Smashmose', nick: 'Deuce Daddy', club: 'Klint GC', nation: 'DK', hcp: 1.4, serve: 192, wins: 6, shorts: 2026, img: 'assets/players/troels.svg', persona: 'Dolph Lundgren' },
  ...
  history: [
    { year: 2026, champ: 'Troels Smashmose', score: '−8 / 6-4 6-3', venue: 'Klint', note: 'Deuce-court forehand on match point cracked a net post; Dolph-quiet through the ceremony' },
...
export const winnerPhotoUrl = `${import.meta.env.BASE_URL}assets/winner-2026.jpg`
